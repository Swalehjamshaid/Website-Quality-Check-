# wsgi.py — FINAL 100% WORKING — NO CRASH — SINGLE PROCESS ONLY
import os
import json
import requests
...
def run_audit(url):
    ...
    result['suggestions'] = ["Compress images","Minify CSS/JS","Add title & meta","Create robots.txt"] if result['performance']<85 else ["Excellent!"]
    return result
...
def download(site_id):
    ...
    return send_file(pdf, as_attachment=True, download_name="37Metrics_Report.pdf")
